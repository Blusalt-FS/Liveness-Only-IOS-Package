...
namespace MegFaceIDActionLive {
    ...
    public:
        ...
        FaceIDActionLiveActionManager();
        FaceIDActionLiveActionManager(bool is_random_action, unsigned int action_timeout, unsigned int action_count, const std::vector<MegFaceIDActionLiveActionType>& action_list);
        unsigned int get_action_timeout();
        unsigned int get_action_count();
        MegFaceIDActionLiveActionType random_action_type();
        void reset_faceidkernel_action();
